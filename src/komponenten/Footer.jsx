    ...
    <footer className="bg-navbar text-paragraphHell p-6 py-20">
      ...
      >
        ...
        <div className="mb-6 sm:mb-0">
          <p className="text-lg font-bold mb-2">{translate ? "Information" : "Informationen"}</p>
        ...
        <div className="mb-6 sm:mb-0">
          <p className="text-lg font-bold mb-2">{translate ? "Contact" : "Kontakt"}</p>
        ...
        <div>
          <p className="text-lg font-bold ">{translate ? "Reach me at" : "Erreichbar unter"}</p>
