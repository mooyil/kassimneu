    ...
    <div>
      <div className="flex flex-col md:flex-row justify-center ">
        ...
        >
          ...
          >
            {data == null || data.data[1].attributes.bilder.data == null ? "" : data.data[1].attributes.bilder.data.map((element, index) => {
              return (
        ...
        >
          <div className="h-full bg-accent py-12 sm:py-0 flex flex-col items-center justify-center">
            <div className="max-w-[80%] ">
              <h3 className="text-2xl sm:text-3xl mb-4">{data == null ? "" :  data.data[1].attributes.titel}</h3>
